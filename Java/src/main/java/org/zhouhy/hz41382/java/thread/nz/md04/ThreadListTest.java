package org.zhouhy.hz41382.java.thread.nz.md04;
...
public class ThreadListTest {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ThreadListTest.class);
	
	private ThreadListTest(){
	...
	public static void main(String[] args) {
		...
		for (String string : getThreadGroups(getRootThreadGroups())) {
            LOGGER.info(string);//遍历输出列表中的字符串
        }
	}
